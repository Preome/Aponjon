    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Aponjon</h3>
            <p className="text-gray-400 mb-4">
              Providing compassionate care and assistance for elderly individuals,
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for care tips and updates.</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Aponjon. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
